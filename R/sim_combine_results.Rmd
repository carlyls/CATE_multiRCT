...
#ggsave("boxplot_main_24Jun2023.jpeg", width=9, height=8)
```
...
all_long %>%
  ...
  theme(axis.text.x = element_text(angle=90),
        text = element_text(size=12))
#ggsave("boxplot_samplesize_24Jun2023.jpeg", width=9, height=6)
```
...
all_long %>%
  ...
  theme(axis.text.x = element_text(angle=90),
        text = element_text(size=12))
#ggsave("boxplot_k30_24Jun2023.jpeg", width=9, height=5)

all_long %>%
  filter(K==15, ensemble != "No Pooling") %>%
  ggplot(aes(x=ensemble, y=MSE)) +
  geom_boxplot(aes(color=base)) +
  facet_wrap(~scenario) +
  #scale_y_continuous(limits = c(0, 2.1)) +
...
all_long %>%
  ...
  theme(axis.text.x = element_text(angle=90),
        text = element_text(size=12))
#ggsave("boxplot_covshift_24Jun2023.jpeg", width=9, height=6)
```
...
all_long %>%
  ...
  theme(axis.text.x = element_text(angle=90),
        text = element_text(size=12))
#ggsave("boxplot_sc2_24Jun2023.jpeg", width=11, height=5)
```
...
all_long %>%
  ...
  theme(axis.text.x = element_text(angle=90),
        text = element_text(size=12))
#ggsave("boxplot_nopool_24Jun2023.jpeg", width=8, height=8)
...
mod_params <- lm(MSE ~ factor(base) + factor(ensemble) + factor(study_sd) + 
                 ...
                 data=filter(means_long, base != "Meta-Analysis", scenario != "Variable CATE"))
summary(mod_params)
anova(mod_params)
